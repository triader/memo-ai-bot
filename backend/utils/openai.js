      ...
      messages: [
        {
          role: 'system',
          content:
            "You are a language learning assistant. Generate a simple, clear sentence using the given word. The sentence should help learners understand the word's usage in context."
        },
        {
          role: 'user',
